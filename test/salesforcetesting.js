...
describe('we should login to salesforce',async function(){
    it('should work', async function(){
        await salesforceIntegration.tearDownSalesforceShapeData().done();
        await loginToSalesforce.login(driver,sfusername,sfpassword).done();
